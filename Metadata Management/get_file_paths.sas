/******************************************************************************/
/* This program pulls a list of all files and their paths defined in metadata */
/* Author: Greg Wootton                                                       */
/******************************************************************************/
...
/* Initialize variables. */
  ...
  /* that have an associated file object. */
  ...
  if fileref_count > 0 then do i = 1 to fileref_count;
    /* If any are found, get their name, which is a full path, */
    /* and output it to the data set as well. */
