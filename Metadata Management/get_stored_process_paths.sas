/******************************************************************************/
/* This program pulls each stored process defined in metadata and its         */
/* associated metadata path.                                                  */
/* Author: Greg Wootton Date: 07FEB2017                                       */
/******************************************************************************/
...
call missing(type,id,stp_uri,tree_uri,partree_uri,
path,folder_name,stp_name,stp_create,stp_update);
