/******************************************************************************/
/* This program demonstrates/tests the LDAP calls used by the SAS importad    */
/* program.                                                                   */
/* Author: Greg Wootton Date: 24DEC2019                                       */
/******************************************************************************/
...
/* *******User demo******* */
  ...
  /* Search LDAP using the filter provided */
  ...
  do i=1 to 1 /*numEntries*/ ;
    ...
    /* For the first entry (or all if replace 1 with */
    /* numEntries above) pull the name and the number of attributes returned. */
...
/* *******Group demo******* */
  ...
  do i=1 to 1 /*numEntries*/ ;
    ...
    /* For the first entry (or all if replace 1 with numEntries */
    /* above) pull the name and the number of attributes returned. */
    call LDAPS_ENTRY(sHandle,i,entryName,numAttrs,rc);
    put "LDAPS_Entry: " i= rc= entryName= numAttrs=;
