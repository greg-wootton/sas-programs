/******************************************************************************/
/* This program pulls a list of all Enterprise Miner projects defined in      */
/* metadata.                                                                  */
/* Author: Greg Wootton Date: 30NOV2016                                       */
/******************************************************************************/
...
/* define kept column labels */
  ...
  label
    ...
    Project_physicalpath="Physical Path"
...
/* Initialize the variables */
  ...
  Project_id,Project_name,Project_physicalpath,Tree_uri,
  treePath,parentTree_uri,parentTree_uri,parentTreePath,
  metadataPath,owner_uri,owner_name,type,id);
